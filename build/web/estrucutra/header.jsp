<%-- 
    Document   : header
    Created on : 28/10/2018, 06:42:46 PM
    Author     : Jesus Torrejon
    proyecto   : Fhercons
--%>
                ...
                <div class="col-sm-6">
                    <div class="contactinfo">
                        <ul class="nav nav-pills">
                            <li><a href="#"><i class="fa fa-phone"></i> +51 95 01 88 821</a></li>
                            <li><a href="#"><i class="fa fa-envelope"></i> info@fhercons.com</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-3">
                    ...
                    <!-- FALTA PROGRAMAR EL BOTON BUSCAR-->
